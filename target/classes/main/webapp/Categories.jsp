    ...
    <div class="container-fluid">
        ...
        <div style="background-color:white;" class="collapse navbar-collapse" id="myNavbar">
           <ul class="nav navbar-nav">
               <li><a href="AdminGrocery.jsp"><span class="glyphicon  glyphicon-grain"></span> Grocery</a></li>
               <li><a href="AdminBook.jsp"><span class="glyphicon  glyphicon-book"></span> Books</a></li>
               <li><a href="AdminElectronics.jsp"><span class="glyphicon  glyphicon-print"></span> Electronics</a></li>
           </ul>
