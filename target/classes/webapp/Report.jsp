    ...
    <div class="container-fluid">
        ...
        <div style="background-color:white;" class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="/customerReport"><span class="glyphicon glyphicon-user"></span> Customers</a></li>
                <li><a href="/orderReport"><span class="glyphicon glyphicon-ok-circle"></span> Orders</a></li>
                <li><a href="/paymentReport"><span class="glyphicon fa fa-rupee"></span> Payment</a></li>
            </ul>
