...
public class EditBookServlet extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int count = AdminUtils.editBook(book);
        PrintWriter out = resp.getWriter();
        if (count > 0) {
            out.println(("<html><script type='text/javascript' src='js/edit_book_success.js'></script></html>"));
        } else {
            out.println(("<html><script type='text/javascript' src='js/edit_book_failure.js'></script></html>"));
        }
        out.close();
    }
}
