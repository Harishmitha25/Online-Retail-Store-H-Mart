...
public class AddGroceryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int count = AdminUtils.addGroceryItem(groceryItem);
        PrintWriter out = resp.getWriter();
        if (count > 0) {
            out.println("<html><script type='text/javascript' src='js/add_grocery_success.js'></script></html>");
        } else {
            out.println("<html><script type='text/javascript'  src='js/add_grocery_failure.js'></script></html>");
        }
        out.close();
    }
}
